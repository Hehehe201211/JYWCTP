...
$(document).ready(function(){    
    $(".navMiddle li a:eq(3)").addClass("active");
    $("body").append($(".jsxxxqB"));        
    $(".hyxzyemian22 tbody td").live("click",function(){
        var fulltime_id = $(this).parent().find('.fulltime_id').val();
        $('.jsxxxqB').load('/homes/detailFulltime', {'id':fulltime_id}, function(){
