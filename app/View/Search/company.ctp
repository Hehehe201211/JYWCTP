...
<div class="main">
    <div class="conResource">
        ...
        <form id="searchOpt">
            <div class="searchBar">
                <input type="text" name="keyword" value="{if isset($this->data['keyword'])}{$this->data['keyword']}{/if}" class="inpTextBox inpTextbox" id="acpro_inp2" style="margin-left:8px;">
                <a href="javascript:void(0)" class="btnBar" style="margin-left:458px;">搜&nbsp;索</a>
            </div>
            <div class="clear">&nbsp;</div>
