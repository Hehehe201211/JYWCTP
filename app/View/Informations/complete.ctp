    ...
    <ul class="ulFormStep ulFormStep3">
        ...
        {else}
            ...
            <p class="gongxiLink">
                ...
                {if $this->data['type'] == Configure::read('Information.type.has')}
                <a id="xxXinjian" href="/informations/create/has">再发布一条&gt;&gt;</a>
                {elseif  $this->data['type'] == Configure::read('Information.type.need')}
                <a id="xxXinjian" href="/informations/create/need">再发布一条&gt;&gt;</a>
                {else}
                <a id="xxXinjian" href="/informations/create/has/?parttime={$this->data['parttime']}&target_member={$this->data['target_member']}">再发布一条&gt;&gt;</a>
                {/if}
            </p>
        {/if}
</div>