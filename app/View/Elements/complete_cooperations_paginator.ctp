...
<table width="100%" cellspacing="0" cellpadding="0" border="0" class="conTable3">
        ...
        {foreach $cooperations as $coop}
            <tr class="con_2_tr">
                <td class="tr_td1">
                    <a target="_blank" href="/cooperations/completedetail/?{$type}={$coop.Cooperation.id}">
                    {if $type == "send"}
                ...
                <td class="tr_td5"><a target="_blank" href="/cooperations/completedetail/?{$type}={$coop.Cooperation.id}">{$status[$coop.Cooperation.status - 1]}</a></td>
                <td class="tr_td5"><a target="_blank" href="/cooperations/completedetail/?{$type}={$coop.Cooperation.id}">{$coop.Cooperation.created|date_format:"%Y-%m-%d"}</a></td>
                <td class="con_2_xq_tofu xiushan_anniu">
                    <a href="/cooperations/completedetail/?{$type}={$coop.Cooperation.id}" target="_blank" style="font-weight: normal;">详情</a>
