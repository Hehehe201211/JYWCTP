    ...
    <div class="mebBaseinfoR">
        <dl>
            <dd>已发布：
                ...
                <a href="javascript:void(0)">{$historyInfo.created_need}</a>条悬赏
            </dd>
            <dd>已收到：
                <a href="javascript:void(0)">{$historyInfo.received_has}</a>条客源&nbsp;&nbsp;
                <a href="javascript:void(0)">{$historyInfo.received_need}</a>条悬赏
            </dd>
            <dd>留言：<a href="javascript:void(0)">{$countStationMessage}</a>条</dd>
    ...
    <div class="mebBaseinfoL">
        <table width="100%" height="100%" border="0">
            ...
            <tr>
                ...
                <a title="未绑定支付宝" href="/members/upgrade" class="icon iconB"></a>
                </td>
            </tr>
        </table>
    </div>
